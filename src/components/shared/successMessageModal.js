...
export function SuccessModal(message) {
	const messageBox = El({
		...
		id: "errorModal",
		classList:
			"p-5 left-0 top-[60%] bottom-0 right-0 m-auto bottom-0 absolute w-[90%] h-min bg-[#eeeeee] text-[#00aa00] shadow-sm  rounded-md text-center flex flex-col gap-5 justify-between",
		innerText: message,
		children: [
			El({
				element: "button",
